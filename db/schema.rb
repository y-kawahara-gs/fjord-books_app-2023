...
ActiveRecord::Schema[7.0].define(version: 2025_10_29_014321) do
  ...
  create_table "mentions", force: :cascade do |t|
    ...
    t.index ["mentioner_id", "mentioned_id"], name: "index_mentions_on_mentioner_id_and_mentioned_id", unique: true
